...
GTFS.prototype.getDBConnection = function() {
  var self = this;
...
GTFS.prototype.buildSchema = function() {
...
GTFS.prototype.createDatabase = function() {
...
GTFS.prototype.insertData = function() {
  ...
  GTFSfiles.forEach(function(name) {
    filePathName = '../data/' + name + '.txt';
...
GTFS.prototype.searchSchedule = function(departure, arrival) {
  // GTFS Diagram
...
GTFS.prototype.retrieveStops = function() {
